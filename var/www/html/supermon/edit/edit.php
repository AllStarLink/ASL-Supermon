...
echo $file;
$fh = fopen($file,
    'r') or die('<br><br> ERROR: Could not open file: '.$file.'<br><br> Does not exist or is Protected.');
...
if (is_writable($file)) {
  ...
  <form style="display:inline;" action="save.php" method="post" name="savefile" target="_self">
    ...
    <textarea name="edit" style="width:100%; height:94%;" wrap="off"><?php
        echo $data; ?></textarea>
  ...
  <form action="save.php" method="post" name="savefile" target="_self">
    <link type='text/css' rel='stylesheet' href='/supermon/supermon.css'>
    <textarea name="edit" style="width:100%; height:87%;" wrap="off"><?php
        echo $data; ?></textarea>
    <input name="filename" type="hidden" value="<?php
    echo $file; ?>">
    <br><br>
