...
echo $BACKGROUND; ?>); background-color:<?php
echo $BACKGROUND_COLOR; ?>; height: <?php
echo $BACKGROUND_HEIGHT; ?> ">
  <div id="headerTitle"><i><?php
          echo "$CALL - $TITLE_LOGGED"; ?></i></div>
  <div id="header3Tag"><i><?php
          echo $title ?></i></div>
  <div id="header2Tag"><i><?php
          echo $TITLE3 ?></i></div>
  <div id="headerImg"><a href="http://allstarlink.org" target="_blank"><img src="allstarlink.jpg" style="border: 0px;"
                                                                            alt="AllStar Logo"></a></div>
</div>
<div id="cpMain">
  <br>
  ...
  <input type="hidden" id="localnode" value="<?php
  echo $node ?>">
